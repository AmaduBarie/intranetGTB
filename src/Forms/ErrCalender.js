...
import { Dialog, confirmDialog } from 'primereact/confirmdialog';
    ...
    return (
        <div>
            ...
            <div className="card">
                ...
                <Dialog resizable closable visible={visible} onHide={() => setVisible(false)} message="Are you sure you want to proceed?"
