...
useEffect(()=>{
    ...
    return ( 
        <Dialog  blockScroll={true} closable={true} resizable header='Event planner'  visible={open} onHide={()=>sopen(false)} maximizable modal style={{ width: '50vw',eight:'5em' }} footer={renderFooter('displayMaximizable')}>
      
      <Dialog blockScroll={true} closable={true} resizable header={"Error"} visible={erralert && true} onHide={()=>sErralert(false)} maximizable modal style={{ width: '50vw',eight:'5em' }}>
