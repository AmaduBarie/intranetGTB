    ...
    const countryTemplate = (option) => {
        return (
            <div className="country-item">
                <img style={{maxWidth:'2em',maxHeight:'2em',borderRadius:'5em'}} alt={option.name} src="person.png" onError={(e) => e.target.src='person.png'} className={`flag flag`} />
        ...
        if (option) {
            return (
                <div style={{display:'flex',alignItems:'center', padding:'3px',margin:'4px'}} className="country-item country-item-value">
                    <img alt={option.username} src='person.png' style={{maxWidth:'2em',maxHeight:'2em',borderRadius:'5em'}} onError={(e) => e.target.src='person.png'} className={`flag flag`} />
